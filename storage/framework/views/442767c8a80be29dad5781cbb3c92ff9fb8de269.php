                        ...
                        <form class="form-horizontal" action="<?php echo e(route('admin.role.permissions.update', $role->id)); ?>" method="POST">
                          ...
                          ?>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-md-6 mt-3">
                                    <div class="icheck-primary d-inline">
                                        <input type="checkbox" name="permissions[]" value="Dynamic Page Categories" id="p12"  <?php if(is_array($permissions) && in_array('Dynamic Page', $permissions)): ?> checked <?php endif; ?>>
                                        <label for="p12">
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/new.vadecom.net/public_html/core/resources/views/admin/role/permission.blade.php ENDPATH**/ ?>