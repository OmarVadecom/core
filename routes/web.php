...
Route::group(['prefix' => LaravelLocalization::setLocale(), 'middleware' => ['localeSessionRedirect', 'localizationRedirect', 'localeViewPath']], function () {
    ...
    Route::get('request-package/{category}/{package}', 'Front\FrontendController@showRequestPackage')->name('site.request_package.show');
    Route::post('request-package', ['as' => 'site.request_package.store', 'uses' => 'Front\FrontendController@storeRequestPackage']);
    Route::get('/thanks/{category}/{package}', 'ContactController@showthanks')->name('site.thanks.package');
...
Route::group(['prefix' => 'admin', 'middleware' => ['auth:admin', 'checkstatus']], function () {
    ...
    Route::group(['middleware' => 'checkpermission:Home'], function () {
        ...
        Route::post('/client/clientContent/{id}/', 'Admin\ClientController@clientContent')->name('admin.clientContent.update');
    ...
    Route::get('/requests', 'Admin\RequestController@index')->name('requests.index');
    Route::get('/requests/{id}', 'Admin\RequestController@show')->name('requests.show');
    Route::get('/requests/delete/{id}', 'Admin\RequestController@delete')->name('requests.delete');
    ...
    Route::group(['middleware' => 'checkpermission:Dynamic Page'], function () {
        ...
        Route::get('/dynamic-page/{module}', 'Admin\DynamicpageController@getModule')->name('admin.dynamic_page.get-module');
    ...
    Route::resource('dynamic-page-categories', 'Admin\DynamicPageCategoryController')
        ->except('show')
        ->middleware('checkpermission:Dynamic Page Categories');
