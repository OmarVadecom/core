            ...
            <div class="tab-content" id="nav-tabContent">
                <div class="tab-pane fade show active" id="nav-en-text-right-img"  role="tabpanel" aria-labelledby="nav-en-text-right-img-tab">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <img class="mw-400 mb-3 show-img img-demo"
                                src="<?php echo e(isset($moduleAttributes['image']) ? asset('assets/front/img/text_with_right_image/' . $moduleAttributes['image']) : asset('assets/admin/img/img-demo.jpg')); ?>"
                                alt="">
                            <div class="custom-file">
                                ...
                                <input
                                    name="images[<?php echo e($randomKey); ?>][text_with_right_image][imageFile]"
                                    class="custom-file-input up-img"
                                    type="file"
                                    id="image"
                                />
                                <input
                                    name="mod[<?php echo e($randomKey); ?>][text_with_right_image][image]"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input
                                name="mod[<?php echo e($randomKey); ?>][text_with_right_image][heading]"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <textarea
                                name="mod[<?php echo e($randomKey); ?>][text_with_right_image][paragraph]"
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="red-button-text">
                                            <input
                                                name="mod[<?php echo e($randomKey); ?>][text_with_right_image][red_button][text]"
                                    ...
                                    <div class="col-md-6">
                                        <div class="red-button-url">
                                            <input
                                                name="mod[<?php echo e($randomKey); ?>][text_with_right_image][red_button][url]"
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="yellow-button-text">
                                            <input
                                                name="mod[<?php echo e($randomKey); ?>][text_with_right_image][yellow_button][text]"
                                    ...
                                    <div class="col-md-6">
                                        <div class="yellow-button-url">
                                            <input
                                                name="mod[<?php echo e($randomKey); ?>][text_with_right_image][yellow_button][url]"
                ...
                <div class="tab-pane fade" id="nav-ar-text-right-img" role="tabpanel" aria-labelledby="nav-ar-text-right-img-tab">
                    ...
                    <div class="form-group row">
                        <label class="col-sm-2 control-label">
                            <?php echo e(__('الصورة')); ?>

                        </label>
                        <div class="col-sm-10">
                            <img class="mw-400 mb-3 show-img img-demo"
                                src="<?php echo e(isset($moduleAttributes['ar_image']) ? asset('assets/front/img/text_with_right_image/' . $moduleAttributes['ar_image']) : asset('assets/admin/img/img-demo.jpg')); ?>"
                                alt="">
                            <div class="custom-file">
                                <label
                                    class="custom-file-label"
                                ...
                                ><?php echo e(__('Choose Image')); ?></label>
                                <input
                                    name="images[<?php echo e($randomKey); ?>][text_with_right_image][ar_imageFile]"
                                    class="custom-file-input up-img"
                                    type="file"
                                    id="image"
                                />
                                <input
                                    name="mod[<?php echo e($randomKey); ?>][text_with_right_image][ar_image]"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input
                                name="mod[<?php echo e($randomKey); ?>][text_with_right_image][ar_heading]"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <textarea
                                name="mod[<?php echo e($randomKey); ?>][text_with_right_image][ar_paragraph]"
                            ...
                            <div class="red-button-text-url">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="red-button-text">
                                            <input
                                                name="mod[<?php echo e($randomKey); ?>][text_with_right_image][red_button][ar_text]"
                                    ...
                                    <div class="col-md-6">
                                        <div class="red-button-url">
                                            <input
                                                name="mod[<?php echo e($randomKey); ?>][text_with_right_image][red_button][ar_url]"
                            ...
                            <div class="yellow-button-text-url">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="yellow-button-text">
                                            <input
                                                name="mod[<?php echo e($randomKey); ?>][text_with_right_image][yellow_button][ar_text]"
                                    ...
                                    <div class="col-md-6">
                                        <div class="yellow-button-url">
                                            <input
                                                name="mod[<?php echo e($randomKey); ?>][text_with_right_image][yellow_button][ar_url]"
            ...
            <div class="tab-content" id="nav-tabContent">
                <div class="tab-pane fade show active" id="nav-en-text-right-img"  role="tabpanel" aria-labelledby="nav-en-text-right-img-tab">
                        ...
                        <div class="col-sm-10">
                            ...
                            <div class="custom-file">
                                ...
                                <input type="file" class="custom-file-input up-img"
                                    name="images[<?php echo e($randNumModule); ?>][text_with_right_image][imageFile]" id="image">
                                <input type="hidden" class="file-image-value"
                                    name="mod[<?php echo e($randNumModule); ?>][text_with_right_image][image]" value="">
                            </div>
                            <?php if($errors->has('image')): ?>
                                <p class="text-danger"> <?php echo e($errors->first('image')); ?> </p>
                            <?php endif; ?>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control"
                                name="mod[<?php echo e($randNumModule); ?>][text_with_right_image][heading]"
                                placeholder="<?php echo e(__('Heading')); ?>">
                            <?php if($errors->has('heading')): ?>
                                <p class="text-danger"> <?php echo e($errors->first('heading')); ?> </p>
                            <?php endif; ?>
                    ...
                    <div class="form-group row">
                        <label class="col-sm-2 control-label"><?php echo e(__('paragraph')); ?></label>
                        <div class="col-sm-10">
                            <textarea name="mod[<?php echo e($randNumModule); ?>][text_with_right_image][paragraph]" class="form-control"
                            ...
                            <div class="red-button-text-url">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="red-button-text">
                                            <input
                                                name="mod[<?php echo e($randNumModule); ?>][text_with_right_image][red_button][text]"
                                                placeholder="Red Button Text"
                                                class="form-control"
                                                type="text"
                                            />
                                    ...
                                    <div class="col-md-6">
                                        <div class="red-button-url">
                                            <input
                                                name="mod[<?php echo e($randNumModule); ?>][text_with_right_image][red_button][url]"
                                                placeholder="Red Button Url"
                                                class="form-control"
                                                type="text"
                                            />
                            ...
                            <div class="yellow-button-text-url">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="yellow-button-text">
                                            <input
                                                name="mod[<?php echo e($randNumModule); ?>][text_with_right_image][yellow_button][text]"
                                                placeholder="Yellow Button Text"
                                                class="form-control"
                                                type="text"
                                            />
                                    ...
                                    <div class="col-md-6">
                                        <div class="yellow-button-url">
                                            <input
                                                name="mod[<?php echo e($randNumModule); ?>][text_with_right_image][yellow_button][url]"
                                                placeholder="Yellow Button Url"
                                                class="form-control"
                                                type="text"
                                            />
                ...
                <div class="tab-pane fade" id="nav-ar-text-right-img" role="tabpanel" aria-labelledby="nav-ar-text-right-img-tab">
                    ...
                    <div class="form-group row my-3">
                        ...
                        <div class="col-sm-10">
                            ...
                            <div class="custom-file">
                                <label class="custom-file-label" for="image"><?php echo e(__('Choose Image')); ?></label>
                                <input type="file" class="custom-file-input up-img"
                                    name="images[<?php echo e($randNumModule); ?>][text_with_right_image][ar_imageFile]" id="image">
                                <input type="hidden" class="file-image-value"
                                    name="mod[<?php echo e($randNumModule); ?>][text_with_right_image][ar_image]" value="">
                            </div>
                            <?php if($errors->has('ar_image')): ?>
                                <p class="text-danger"> <?php echo e($errors->first('ar_image')); ?> </p>
                            <?php endif; ?>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control"
                                name="mod[<?php echo e($randNumModule); ?>][text_with_right_image][ar_heading]"
                                placeholder="<?php echo e(__('العنوان')); ?>">
                            <?php if($errors->has('ar_heading')): ?>
                                <p class="text-danger"> <?php echo e($errors->first('ar_heading')); ?> </p>
                            <?php endif; ?>
                    ...
                    <div class="form-group row">
                        <label class="col-sm-2 control-label"><?php echo e(__('المحتوي')); ?></label>
                        <div class="col-sm-10">
                            <textarea name="mod[<?php echo e($randNumModule); ?>][text_with_right_image][ar_paragraph]" class="form-control"
                            ...
                            <div class="red-button-text-url">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="red-button-text">
                                            <input
                                                name="mod[<?php echo e($randNumModule); ?>][text_with_right_image][red_button][ar_text]"
                                                placeholder="Red Button Text"
                                                class="form-control"
                                                type="text"
                                            />
                                    ...
                                    <div class="col-md-6">
                                        <div class="red-button-url">
                                            <input
                                                name="mod[<?php echo e($randNumModule); ?>][text_with_right_image][red_button][ar_url]"
                                                placeholder="Red Button Url"
                                                class="form-control"
                                                type="text"
                                            />
                            ...
                            <div class="yellow-button-text-url">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="yellow-button-text">
                                            <input
                                                name="mod[<?php echo e($randNumModule); ?>][text_with_right_image][yellow_button][ar_text]"
                                                placeholder="Yellow Button Text"
                                                class="form-control"
                                                type="text"
                                            />
                                    ...
                                    <div class="col-md-6">
                                        <div class="yellow-button-url">
                                            <input
                                                name="mod[<?php echo e($randNumModule); ?>][text_with_right_image][yellow_button][ar_url]"
                                                placeholder="Yellow Button Url"
                                                class="form-control"
                                                type="text"
                                            />
...
<?php /**PATH /home/customer/www/new.vadecom.net/public_html/core/resources/views/admin/modules/style_of_modules/text_with_right_image.blade.php ENDPATH**/ ?>