...
class GalleryController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $galleryCategories  = Gcategory::where('language_id', $lang)->get();
        $galleries          = Gallery::where('language_id', $lang)
        ...
        return view('admin.gallery.index', compact('galleries', 'galleryCategories'));
    }
