                    ...
                    <div class="form-group row my-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="mod[<?php echo e($randomKey); ?>][section_with_icon][ar_class_icon]"
                                placeholder="<?php echo e(__('الصورة')); ?>" value="<?php echo e($moduleAttributes['ar_class_icon']); ?>"/>
...
<div class="clearfix"></div><?php /**PATH C:\laragon\www\core\resources\views/admin/modules/style_of_modules/section_with_icon.blade.php ENDPATH**/ ?>