                ...
                <div class="col-lg-12">
                    <div class="card card-primary card-outline">
                        ...
                        <div class="card-body">
                            ...
                            <form
                                action="<?php echo e(route('admin.team_section_update',  $english_static->language_id)); ?>" method="POST"
                                ...
                                <div class="tab-content" id="nav-tabContent">
                                    <div class="col-md-12 tab-pane fade show active" id="nav-en-team" role="tabpanel" aria-labelledby="nav-en-team-tab" >
                                        ...
                                        <div class="form-group row my-3">
                                            ...
                                            <div class="col-sm-10">
                                                <input
                                                    value="<?php echo e($english_static->team_title); ?>"
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input
                                                    value="<?php echo e($english_static->team_sub_title); ?>"
                                    ...
                                    <div class="col-md-12 tab-pane fade" id="nav-ar-team" role="tabpanel" aria-labelledby="nav-ar-team-tab">
                                        ...
                                        <div class="form-group row my-3">
                                            <label class="col-sm-2 control-label"><?php echo e(__('العنوان')); ?>

                                                <span class="text-danger">*</span>
                                            </label>
                                            <div class="col-sm-10">
                                                <input
                                                    value="<?php echo e($arabic_static->team_title); ?>"
                                                    placeholder="<?php echo e(__('العنوان')); ?>"
                                                    class="form-control"
                                                    name="ar_team_title"
                                                    type="text"
                                                >
                                                <?php if($errors->has('ar_team_title')): ?>
                                                    <p class="text-danger"> <?php echo e($errors->first('ar_team_title')); ?> </p>
                                                <?php endif; ?>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input
                                                    value="<?php echo e($arabic_static->team_sub_title); ?>"
                                                    placeholder="<?php echo e(__('العنوان الفرعي')); ?>"
                                                    name="ar_team_sub_title"
                                                    class="form-control"
                                                    type="text"
                                                >
                                                <?php if($errors->has('ar_team_sub_title')): ?>
                                                    <p class="text-danger"> <?php echo e($errors->first('ar_team_sub_title')); ?> </p>
                                                <?php endif; ?>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-12">
                                    <div class="row">
                                        <div class="col-12">
                                            ...
                                            <form action="<?php echo e(route('admin.team')); ?>" method="get">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-3">
                                                        ...
                                                        >Dagenation</label>
                                                        <input
                                                            value="<?php echo e(request()->get('dagenation')); ?>"
                                                            class="form-control"
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $teams; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id=>$team): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?php echo e(route('admin.team.edit', $team->id)); ?>" class="btn btn-info btn-sm">
                                                    <i class="fas fa-pencil-alt"></i><?php echo e(__('Edit')); ?>

                                                </a>
                                                <form
                                                    action="<?php echo e(route('admin.team.delete', $team->id )); ?>"
