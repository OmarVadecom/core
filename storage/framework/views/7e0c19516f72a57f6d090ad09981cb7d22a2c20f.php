                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="tab-content" id="nav-tabContent" >
                                        <div class=" col-sm-10 tab-pane fade show active " id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                                            ...
                                            <input type="text" class="form-control" name="question_en" placeholder="<?php echo e(__('question')); ?>" value="<?php echo e(old('question')); ?>">
                                            ...
                                            <textarea id="editor1" class="form-control" name="answer_en"> </textarea>
                                        ...
                                        <div class="col-sm-10 tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-home-tab">
                                            ...
                                            <input type="text" class="form-control" name="question_ar" placeholder="<?php echo e(__('السؤال')); ?>" value="<?php echo e(old('question_ar')); ?>">
                                            ...
                                            <textarea id="editor2" class="form-control" name="answer_ar"> </textarea>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/new.vadecom.net/public_html/core/resources/views/admin/faq/faq_add.blade.php ENDPATH**/ ?>