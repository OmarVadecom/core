                                ...
                                <div class="col-12">
                                    <div class="row">
                                        <div class="col-12">
                                            ...
                                            <form action="<?php echo e(route('admin.product')); ?>" method="get">

                                                <input type="hidden" name="language" value="<?php echo e(request('language')); ?>"/>
                                                <div class="row">
                                                    <div class="col-3">
                                                        <label class="<?php if($currentLang->code === 'ar'): ?> text-left <?php endif; ?>" for="price">Price</label>
                                                        <input
                                                            value="<?php echo e(request()->get('price')); ?>"
                                                            class="form-control"
                                                            placeholder="Price"
                                                            type="text"
                                                            name="price"
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id=>$product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr id="product-bulk-delete">
                                            ...
                                            <td>
                                                <a href="<?php echo e(route('admin.product.edit', $product->id)); ?>" class="btn btn-info btn-sm">
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/new.vadecom.net/public_html/core/resources/views/admin/product/index.blade.php ENDPATH**/ ?>