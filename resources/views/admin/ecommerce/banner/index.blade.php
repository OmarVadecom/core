                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="card-tools d-flex justify-content-end">
                                                ...
                                                <a href="{{ route('admin.ecommerce.bannerAdd'). '?language=' . $currentLang->code }}"
                                ...
                                <div class="col-12">
                                    <div class="row">
                                        <div class="col-12">
                                            ...
                                            <form action="{{ route('admin.ecommerce.banner') }}" method="get">
                            ...
                            <table class="table table-striped table-bordered data_table">
                                ...
                                @foreach ($banners as $id=>$banner)
                                    <tr>
                                        ...
                                        <td>
                                            <img class="w-80" src="{{ asset('assets/front/img/'.$banner->image) }}"
                                                 alt="">
                                        </td>
                                        <td>
                                            {{ $banner->title }}
                                        ...
                                        <td>
                                            <a href="{{ route('admin.ecommerce.bannerEdit', $banner->id) }}"
