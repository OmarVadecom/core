                            ...
                            <form class="form-horizontal" action="<?php echo e(route('faq.store')); ?>" method="POST">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="tab-content" id="nav-tabContent" >
                                        <div class=" col-sm-10 tab-pane fade show active " id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                                            ...
                                            <input type="text" class="form-control" name="question_en" placeholder="<?php echo e(__('question')); ?>" value="<?php echo e($faq->question_en); ?>">
                                            ...
                                            <textarea id="editor1" class="form-control" name="answer_en"><?php echo e($faq->answer_en); ?> </textarea>
                                        ...
                                        <div class="col-sm-10 tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-home-tab">
                                            ...
                                            <input type="text" class="form-control" name="question_ar" placeholder="<?php echo e(__('السؤال')); ?>" value="<?php echo e($faq->question_ar); ?>">
                                            ...
                                            <textarea id="editor2" class="form-control" name="answer_ar"><?php echo e($faq->answer_ar); ?> </textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <?php $__currentLoopData = $faqs_categoris; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fcat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($fcat->id); ?>" <?php echo e(( $fcat->id == $faq->category_id) ? 'selected' : ''); ?>> <?php echo e($fcat->name_en); ?> </option>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/new.vadecom.net/public_html/core/resources/views/admin/faq/faq_edit.blade.php ENDPATH**/ ?>