            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-primary card-outline">
                        ...
                        <div class="card-body">
                            <form
                                action="{{ route('admin.footer.update', $footerinfo->language_id) }}"
...
{{--                                    <div class="col-sm-10">--}}
{{--                                        <img--}}
{{--                                            src="{{ asset('assets/front/img/' . $footerinfo->footer_logo) }}"--}}
...
{{--                                            name="footer_text"--}}
{{--                                            type="text"--}}
{{--                                        >{{ $footerinfo->footer_text }}</textarea>--}}
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea
                                            ...
                                            name="copyright_text"
                                            type="text"
                                        >{{ $footerinfo->copyright_text }}</textarea>
