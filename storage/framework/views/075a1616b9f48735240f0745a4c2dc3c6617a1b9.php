                ...
                <div class="col-lg-12">
                    <div class="card card-primary card-outline">
                        ...
                        <div class="card-body">
                            ...
                            <form
                                action="<?php echo e(route('admin.clientContent.update',  $seactiontitle_en->language_id)); ?>" class="form-horizontal" method="POST" >
                                <?php echo csrf_field(); ?>
                                <div class="tab-content" id="nav-tabContent">
                                    <div class="col-md-12 tab-pane fade show active" id="nav-en-client" role="tabpanel" aria-labelledby="nav-en-client-tab" >
                                        ...
                                        <div class="form-group row my-3">
                                            ...
                                            <div class="col-sm-9">
                                                <input
                                                    value="<?php echo e($seactiontitle_en->blog_sub_title); ?>"
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input
                                                    value="<?php echo e($seactiontitle_en->blog_title); ?>"
                                    ...
                                    <div class="col-md-12 tab-pane fade" id="nav-ar-client" role="tabpanel" aria-labelledby="nav-ar-client-tab">
                                        ...
                                        <div class="form-group row my-3">
                                            ...
                                            <div class="col-sm-9">
                                                <input
                                                    value="<?php echo e($seactiontitle_ar->blog_sub_title); ?>"
                                                    placeholder="Client Section Sub Title"
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input
                                                    value="<?php echo e($seactiontitle_ar->blog_title); ?>"
                                                    placeholder="Client Section Title"
                                                    class="form-control"
                                                    name="ar_blog_title"
                                                    type="text"
