                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <img class="mw-400 mb-3 img-demo show-img" src="<?php echo e(asset('assets/front/img/'.$english_static->hero_bg_image)); ?>" alt="" width="150px" height="150px">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <img class="mw-400 mb-3 img-demo show-img" src="<?php echo e(asset('assets/front/img/'.$english_static->hero_image)); ?>" alt="" width="150px" height="150px">
                                                    <div class="custom-file">
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/new.vadecom.net/public_html/core/resources/views/admin/home/hero/static/index.blade.php ENDPATH**/ ?>