                                ...
                                <tbody>
                                    @foreach ($pcategory as $id => $category)
                                        <tr id="product-category-bulk-delete">
                                            ...
                                            <td>
                                                <form
                                                    action="{{route('admin.product.category.makePopular')}}"
                                                    id="popularStatusForm{{$category->id}}"
                                                ...
                                                >
                                                    ...
                                                    <select
                                                        class="
                                                                ...
                                                                "
                                                        name="is_popular"
                                                        onchange="document.getElementById('popularStatusForm{{$category->id}}').submit();"
                                                    >
                                                        <option value="0" {{$category->is_popular == '0' ? 'selected' : ''}}>
                                                            Disable
                                                        </option>
                                                        <option value="1" {{$category->is_popular == '1' ? 'selected' : ''}}>
                                                            Enable
                                                        </option>
                                                    </select>
                                                </form>
                                            ...
                                            <td>
                                                <form
                                                    action="{{route('admin.product.category.makeFeatured')}}"
                                                    id="featuredStatusForm{{$category->id}}"
                                                    class="d-inline-block"
                                                    method="post"
                                                >
                                                    @csrf
                                                    ...
                                                    <select
                                                        ...
                                                        "
                                                        name="is_feature"
                                                        onchange="document.getElementById('featuredStatusForm{{$category->id}}').submit();"
                                                    >
