                                        ...
                                        <div class="col">
                                            <div class="collapse multi-collapse in show" id="multiCollapseExample1" >
                                                <div class="card card-body">
                                                    ...
                                                    <input type="text" class="form-control slugable" name="title" data-slug="1"  placeholder="<?php echo e(__('Title')); ?>" value="<?php echo e($dynamicpage->title); ?>">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col">
                                            <div class="collapse multi-collapse" id="multiCollapseExample2">
                                                <div class="card card-body">
                                                    ...
                                                    <input type="text" class="form-control slugable" name="title" data-slug="0"  placeholder="<?php echo e(__('Title')); ?>" value="<?php echo e($dynamicpage->title); ?>">
                                                </div>
                                            </div>
