                                ...
                                <div class="col-sm-10">
                                    ...
                                    <div class="tab-content" id="nav-tabContent" >
                                        ...
                                        <div class="col-sm-10 tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-home-tab">
                                            ...
                                            <input type="text" class="form-control slugable" name="ar_title" data-slug="0"  placeholder="العنوان"  value="<?php echo e(isset($dynamicpage_ar->title) ? $dynamicpage_ar->title : ''); ?>">
                                            ...
                                            <input type="text" class="form-control" data-role="tagsinput" name="ar_meta_keywords" placeholder="الكلمات الدلاليه لمحركات البحث" value="<?php echo e(isset($dynamicpage_ar->meta_keywords) ? $dynamicpage_ar->meta_keywords : ''); ?>">
                                            ...
                                            <textarea class="form-control" name="ar_meta_description" placeholder="الوصف لمحركات البحث"  rows="4"><?php echo e(isset($dynamicpage_ar->meta_description) ? $dynamicpage_ar->meta_description : ''); ?></textarea>
