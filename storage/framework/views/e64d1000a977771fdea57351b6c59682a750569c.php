                        ...
                        <div class="card-header">
                          ...
                          <div class="card-body">
                            <form class="form-horizontal" action="<?php echo e(route('admin.dynamic_page.store')); ?>" method="POST"
                                       ...
                                       <br>
                                        <div class="tab-content" id="nav-tabContent" >
                                            <div class=" col-sm-10 tab-pane fade show active " id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                                                ...
                                                <input type="text" class="form-control titleinp" name="en_title" data-slug="1"  placeholder="<?php echo e(__('Title')); ?>" required>
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-2 control-label">Include <?php echo e(__('Category')); ?> within slug</label>
                                    <div class="col-sm-4">
                                ...
                                <div class="form-group row">
                                    <label for="status" class="col-sm-2 control-label"><?php echo e(__('Status')); ?>
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-2 control-label"><?php echo e(__('Modules')); ?>
