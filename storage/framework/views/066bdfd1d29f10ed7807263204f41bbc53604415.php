<div class="card">
    ...
    <div class="card-body" style="display: none">
        <div class="form-group row">
            ...
            <div class="col-sm-9">
                <select class="form-control" name="mod[<?php echo e($randNumModule); ?>][faq_category][category_id]" >
                    <option value="">Choose Category</option>
                    <?php $__currentLoopData = \App\Helpers\Helper::getModule(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
