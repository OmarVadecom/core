...
class JobController extends Controller
{
    ...
    public function jobs(Request $request){
        ...
        $data['jCategories']    = Jcategory::where('language_id', $lang)->get();
        $data['jobs']           = Job::where('language_id', $lang)
                                    ...
                                    })->when($request['j_category_id'], function ($q) use ($request) {
                                        return $q->where('jcategory_id', $request['j_category_id']);
                                    })->orderBy('id', 'DESC')->get();
