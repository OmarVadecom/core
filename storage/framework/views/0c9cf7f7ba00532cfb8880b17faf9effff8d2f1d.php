            ...
            <div class="tab-content" id="nav-tabContent">
                ...
                <div class="tab-pane fade show active" id="nav-en-bannar"  role="tabpanel" aria-labelledby="nav-en-bannar-tab">
                    ...
                    <div class="form-group row my-3">
                        <label class="col-sm-2 control-label"><?php echo e(__('Image')); ?></label>
                        <div class="col-sm-10">
                                <input type="text" class="form-control" name="images[<?php echo e($randNumModule); ?>][bannar][imageFile]" id="image"> 
                ...
                <div class="tab-pane fade" id="nav-ar-bannar" role="tabpanel" aria-labelledby="nav-ar-bannar-tab">
                    ...
                    <div class="form-group row my-3">
                        <label class="col-sm-2 control-label"><?php echo e(__('الصورة')); ?></label>
                        <div class="col-sm-10">
                            <input type="file" class="form-control" name="images[<?php echo e($randNumModule); ?>][bannar][ar_imageFile]" id="image">
                                <input type="hidden" class="form-control" name="mod[<?php echo e($randNumModule); ?>][bannar][ar_image]" value="">
                            <?php if($errors->has('ar_image')): ?>
                                <p class="text-danger"> <?php echo e($errors->first('ar_image')); ?> </p>
                            <?php endif; ?>
                        </div>
...
<?php /**PATH C:\PHP\htdocs\new_vadecom\core\resources\views/admin/modules/style_of_modules/bannar.blade.php ENDPATH**/ ?>