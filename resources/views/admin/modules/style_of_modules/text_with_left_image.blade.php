            ...
            <div class="tab-content" id="nav-tabContent">
                ...
                <div class="tab-pane fade" id="nav-ar-text-left-img" role="tabpanel" aria-labelledby="nav-ar-text-left-img-tab">
                    ...
                    <div class="form-group row my-3">
                        ...
                        <div class="col-sm-10">
                            <img
                                src="{{isset($moduleAttributes['ar_image']) ? asset('assets/front/img/text_with_left_image/' . $moduleAttributes['ar_image']) : asset('assets/admin/img/img-demo.jpg') }}"
                                class="mw-400 mb-3 show-img img-demo"
                                alt=""
                            >
                            <div class="custom-file">
                                ...
                                >{{ __('Choose Image') }}</label>
                                <input
                                    name="images[{{ $randomKey }}][text_with_left_image][ar_imageFile]"
                                    class="custom-file-input up-img"
                                    type="file"
                                    id="image"
                                />
                                <input
                                    name="mod[{{ $randomKey }}][text_with_left_image][ar_image]"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input
                                name="mod[{{ $randomKey }}][text_with_left_image][ar_heading]"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <textarea
                                name="mod[{{ $randomKey }}][text_with_left_image][ar_paragraph]"
                            ...
                            <div class="red-button-text-url">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="red-button-text">
                                            <input
                                                name="mod[{{ $randomKey }}][text_with_left_image][red_button][ar_text]"
                                    ...
                                    <div class="col-md-6">
                                        <div class="red-button-url">
                                            <input
                                                name="mod[{{ $randomKey }}][text_with_left_image][red_button][ar_url]"
                            ...
                            <div class="yellow-button-text-url">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="yellow-button-text">
                                            <input
                                                name="mod[{{ $randomKey }}][text_with_left_image][yellow_button][ar_text]"
                                    ...
                                    <div class="col-md-6">
                                        <div class="yellow-button-url">
                                            <input
                                                name="mod[{{ $randomKey }}][text_with_left_image][yellow_button][ar_url]"
            ...
            <div class="tab-content" id="nav-tabContent">
                ...
                <div class="tab-pane fade" id="nav-ar-text-left-img" role="tabpanel" aria-labelledby="nav-ar-text-left-img-tab">
                        ...
                        <div class="col-sm-10">
                            ...
                            <div class="custom-file">
                                ...
                                <input type="file" class="custom-file-input up-img"
                                    name="images[{{ $randNumModule }}][text_with_left_image][ar_imageFile]" id="image">
                                <input type="hidden" class="file-image-value"
                                    name="mod[{{ $randNumModule }}][text_with_left_image][ar_image]" value="">
                            </div>
                            @if ($errors->has('ar_image'))
                                <p class="text-danger"> {{ $errors->first('ar_image') }} </p>
                            @endif
                    ...
                    <div class="form-group row">
                        <label class="col-sm-2 control-label">{{ __('العنوان') }}</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="mod[{{ $randNumModule }}][text_with_left_image][ar_heading]" placeholder="{{ __('العنوان') }}" >
                            @if ($errors->has('ar_heading'))
                                <p class="text-danger"> {{ $errors->first('ar_heading') }} </p>
                            @endif
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <textarea name="mod[{{ $randNumModule }}][text_with_left_image][ar_paragraph]" class="form-control"  rows="3" placeholder="{{ __('المحتوي') }}" ></textarea>
                            @if ($errors->has('ar_paragraph'))
                                <p class="text-danger"> {{ $errors->first('ar_paragraph') }} </p>
                            @endif
                        </div>
                            ...
                            <div class="red-button-text-url">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="red-button-text">
                                            <input
                                                name="mod[{{ $randNumModule }}][text_with_left_image][red_button][ar_text]"
                                                placeholder="Red Button Text"
                                                class="form-control"
                                                type="text"
                                            />
                                    ...
                                    <div class="col-md-6">
                                        <div class="red-button-url">
                                            <input
                                                name="mod[{{ $randNumModule }}][text_with_left_image][red_button][ar_url]"
                                                placeholder="Red Button Url"
                                                class="form-control"
                                                type="text"
                                            />
                            ...
                            <div class="yellow-button-text-url">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="yellow-button-text">
                                            <input
                                                name="mod[{{ $randNumModule }}][text_with_left_image][yellow_button][ar_text]"
                                                placeholder="Yellow Button Text"
                                                class="form-control"
                                                type="text"
                                            />
                                    ...
                                    <div class="col-md-6">
                                        <div class="yellow-button-url">
                                            <input
                                                name="mod[{{ $randNumModule }}][text_with_left_image][yellow_button][ar_url]"
                                                placeholder="Yellow Button Url"
                                                class="form-control"
                                                type="text"
                                            />
