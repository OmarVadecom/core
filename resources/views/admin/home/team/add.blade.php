                                ...
                                <form class="form-horizontal" action="{{ route('admin.team.store') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="tab-content" id="nav-tabContent">
                                        <div class="form-group row my-3">
                                            ...
                                            <div class="col-sm-10">
                                                <img class="w-100 mb-3 show-img img-demo" src="{{ asset('assets/admin/img/img-demo.jpg') }}" alt="" width="150px" height="150px">
                                        ...
                                        <div class="col-md-12 tab-pane fade" id="nav-ar-team" role="tabpanel" aria-labelledby="nav-ar-team-tab">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control" name="ar_dagenation" placeholder="{{ __('Designation') }}" value="{{ old('ar_dagenation') }}">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <textarea name="ar_description" class="form-control summernote" rows="5" placeholder="{{ __('Description') }}">{{ old('ar_description') }}</textarea>
