            ...
            <div class="header-left">
                <div class="site-logo">
                    <a href="<?php echo e(route('front.index')); ?>">
                        <img
                            src="<?php echo e(asset('assets/front/img/' . $setting->header_logo )); ?>"
                            alt="Omnivus"
                        />
                    </a>
                </div>
...
</header><?php /**PATH /home/customer/www/new.vadecom.net/public_html/core/resources/views/front/partials/menu/menu2.blade.php ENDPATH**/ ?>