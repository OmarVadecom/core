            ...
            <div class="col-lg-12">
                    <div class="card card-primary card-outline">
                            <div class="card-header">
                                <h3 class="card-title mt-1"><?php echo e(__('Add Package')); ?></h3>
                            ...
                            <!-- /.card-header -->
                            <div class="card-body">
                                <form class="form-horizontal" action="<?php echo e(route('admin.package.store')); ?>" method="POST">
                                    <?php echo csrf_field(); ?>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="title_ar" placeholder="<?php echo e(__('Title AR')); ?>" value="<?php echo e(old('title_ar')); ?>">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control titleinp" name="title_en" placeholder="<?php echo e(__('Title EN')); ?>" value="<?php echo e(old('title_en')); ?>">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="number" class="form-control" name="old_price" placeholder="<?php echo e(__('Old Price')); ?>" value="<?php echo e(old('old_price')); ?>">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="number" class="form-control" name="price" placeholder="<?php echo e(__('Price')); ?>" value="<?php echo e(old('price')); ?>">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input name="feature_ar" class="form-control" data-role="tagsinput"  value="<?php echo e(old('feature_ar')); ?>" >
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input name="feature_en" class="form-control" data-role="tagsinput"  value="<?php echo e(old('feature_en')); ?>" >
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="button_text" placeholder="<?php echo e(__('Button Text')); ?>" value="<?php echo e(old('button_text')); ?>">
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/new.vadecom.net/public_html/core/resources/views/admin/package/add.blade.php ENDPATH**/ ?>