                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="card-tools d-flex justify-content-end">
                                        <a class="btn btn-primary btn-sm box--shadow1 text-white text--small"
                                           data-toggle="modal" data-target="#myModal">
                                            <i class="la la-plus"></i>
                                            <?php echo app('translator')->get('Add New Language'); ?>
                                        </a>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="row">
                                        <div class="col-12">
                                            ...
                                            <form action="<?php echo e(route('admin.language-manage')); ?>" method="get">
                                                <div class="row">
                                                    <div class="col-3">
                                                        <label
                                                    ...
                                                    <div class="col-3">
                                                        ...
                                                        >Code</label>
                                                        <input
                                                            value="<?php echo e(request()->get('code')); ?>"
                                                            class="form-control"
                                                            placeholder="Code"
                                                            name="code"
                                                            type="text"
                                                    ...
                                                    <div class="col-3">
                                                        ...
                                                        >Direction</label>
                                                        <input
                                                            value="<?php echo e(request()->get('direction')); ?>"
                                        ...
                                        <tr>
                                            ...
                                            <td data-label="<?php echo app('translator')->get('Action'); ?>">
                                                <a href="<?php echo e(route('admin.language-key', $item->id)); ?>"
                                                   class="icon-btn btn--success btn btn-success btn-sm">
                                                ...
                                                <a href="javascript:void(0)"
                                                   ...
                                                   data-lang="<?php echo e(json_encode($item->only('name', 'text_align', 'is_default', 'direction'))); ?>"
                                                   data-icon="">
                                                ...
                                                <?php if($item->id != 1): ?>
                                                    <a href="javascript:void(0)"
                                                       class="icon-btn btn--danger ml-1 deleteBtn btn btn-danger btn-sm"
                                                       data-url="<?php echo e(route('admin.language-manage-del', $item->id)); ?>"
    ...
    <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                ...
                <form
                    action="<?php echo e(route('admin.language-manage-store')); ?>"
                ...
                >
                    ...
                    <div class="modal-body">
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input
                                    placeholder="<?php echo app('translator')->get('e.g. Japaneese, Portuguese'); ?>"
                                    class="form-control has-error bold"
                                    type="text"
                                    name="name"
                                    id="code"
                                    required
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input
                                    class="form-control has-error bold"
                                    placeholder="<?php echo app('translator')->get('e.g. jp, pt-br'); ?>"
                                    type="text"
                                    name="code"
                                    id="link"
                                    required
                ...
                <form method="post" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <select class="form-control direction_update" name="direction"></select>
                            </div>
                        </div>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/new.vadecom.net/public_html/core/resources/views/admin/language/index.blade.php ENDPATH**/ ?>