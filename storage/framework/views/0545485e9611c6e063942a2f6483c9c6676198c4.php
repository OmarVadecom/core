                            ...
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="row">
                                        <div class="col-12">
                                            <h4> Filter Data </h4>
                                            <form action="<?php echo e(route('admin.gallery.index')); ?>" method="get">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-3">
                                                        <label class="<?php if($currentLang->code === 'ar'): ?> text-left <?php endif; ?>" for="category">Category</label>
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $galleries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $gallery): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr id="gallery-bulk-delete">
                                            <td>
                                                <input type="checkbox" class="bulk-item" value="<?php echo e($gallery->id); ?>" />
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <a
                                                    href="<?php echo e(route('admin.gallery.edit', $gallery->id)); ?>"
                                                ...
                                                <form
                                                    action="<?php echo e(route('admin.gallery.delete', $gallery->id )); ?>"
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/new.vadecom.net/public_html/core/resources/views/admin/gallery/index.blade.php ENDPATH**/ ?>