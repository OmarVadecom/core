                ...
                <div class="form-group row my-3">
                    ...
                    <div class="col-sm-10">
                            ...
                            <input type="text" class="form-control"
                                name="mod[<?php echo e($randNumModule); ?>][text_with_right_image][image]" id="image">
                        <?php if($errors->has('image')): ?>
                            <p class="text-danger"> <?php echo e($errors->first('image')); ?> </p>
                        <?php endif; ?>
                    </div>
...
<?php /**PATH C:\PHP\htdocs\filemanager\vadecome\core\resources\views/admin/modules/style_of_modules/text_with_right_image.blade.php ENDPATH**/ ?>