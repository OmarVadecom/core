        ...
        <div class="container">
            <div class="row justify-content-center align-items-center">
                <div class="col-lg-6 col-md-8">
                    <div class="about-thumb" style="width: 550px;height: 650px;text-align: center; line-height: 650px;">
                        <img src="<?php echo e($module['image'] ? asset('' . $module['image'])  : asset('assets/admin/img/img-demo.jpg')); ?>" alt="Image">
                    </div>
                </div>
                    ...
                    <div class="col-lg-6 col-md-10">
                        <div class="about-text-block pl-lg-5 mt-md-gap-60">
                            <div class="section-title mb-40">
                                <h2 class="title"><?php echo e($module['ar_heading']); ?></h2>
                            </div>
            ...
            <?php else: ?>
                    <div class="col-lg-6 col-md-10">
                        <div class="about-text-block pl-lg-5 mt-md-gap-60">
                            <div class="section-title mb-40">
                                <h2 class="title"><?php echo e($module['heading']); ?></h2>
                            </div>
...
<?php /**PATH C:\PHP\htdocs\filemanager\vadecome\core\resources\views/admin/modules/themes_for_modules/text_with_left_image.blade.php ENDPATH**/ ?>