                                ...
                                <div class="col-12">
                                    <div class="row">
                                        <div class="col-12">
                                            ...
                                            <form action="<?php echo e(route('admin.blog')); ?>" method="get">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-3">
                                                        ...
                                                        <select class="form-control" name="category_id" id="category">
                                                            ...
                                                            <?php $__currentLoopData = $bCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <option
                            ...
                            <table id="idtable" class="table table-bordered table-striped data_table">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="width: 49% !important;"><?php echo e(__('Title')); ?></th>
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $blogs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $blog): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr id="blog-bulk-delete">
                                            <td>
                                                <input type="checkbox" class="bulk-item" value="<?php echo e($blog->id); ?>" />
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <a
                                                    href="<?php echo e(route('admin.blog.edit', $blog->id)); ?>"
                                                ...
                                                <form
                                                    action="<?php echo e(route('admin.blog.delete', $blog->id )); ?>"
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/new.vadecom.net/public_html/core/resources/views/admin/blog/index.blade.php ENDPATH**/ ?>