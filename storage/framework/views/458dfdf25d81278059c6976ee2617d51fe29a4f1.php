...
<aside class="main-sidebar elevation-4 main-sidebar elevation-4 sidebar-light-primary">
    ...
    <div class="sidebar pt-0 mt-0">
        ...
        <div class="user-panel">
            <a href="<?php echo e(route('front.index')); ?>" class="name text-dark" target="_blank">
                <img src="<?php echo e(asset('assets/front/img/small-size.png')); ?>" alt="">
            </a>
        </div>
        <!-- Sidebar Menu -->
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column " data-widget="treeview" role="menu"
                ...
                <li class="nav-item">
                    <a href="<?php echo e(route('requests.index')); ?>"
                        class="nav-link <?php if(request()->path() == 'admin/requests'): ?> active <?php endif; ?>">
                        <i class="nav-icon far fa-copy"></i>
                        <p>
                            <?php echo e(__('Requests')); ?> <span style="padding: 0px 4px 1px 4px; border-radius: 22px; background: red; color: #fff; font-size: 13px; font-weight: 800;position: relative; bottom: 1px;"><?php echo e(count(Helper::unreadrequests())); ?></span>
                        </p>
                    </a>
                </li>
                ...
                <li class="nav-item <?php if(request()->path() == 'admin/dynamic-page'): ?> menu-open <?php endif; ?>">
                    <a href="#" class="nav-link <?php if(request()->path() == 'admin/dynamic-page'): ?> active <?php endif; ?>">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a
                                ...
                                href="<?php echo e(route('admin.dynamic_page'). '?language=' . $lang_code); ?>"
                            >
                        ...
                        <li class="nav-item">
                            <a href="<?php echo e(route('dynamic-page-categories.index'). '?language=' . $lang_code); ?>"
                               class="nav-link <?php if(request()->path() == 'admin/dynamic-page-categories'): ?> active <?php endif; ?>">
            ...
            <?php if(request()->path() == 'admin/package' || request()->path() == 'admin/package-category'): ?> menu-open
            <?php elseif(request()->path() == 'admin/package/add'): ?> menu-open
            <?php elseif(request()->is('admin/package/edit/*') || request()->is('admin/package-category/*')): ?> menu-open
            <?php endif; ?>
                    ">
                <a href="#" class="nav-link
                <?php if(request()->path() == 'admin/package-category' || request()->path() == 'admin/package'): ?> active <?php endif; ?>">
                ...
                <ul class="nav nav-treeview">
                    <li class="nav-item">
                        <a href="<?php echo e(route('admin.package'). '?language=' . $lang_code); ?>"
                           class="nav-link <?php if(request()->path() == 'admin/package'): ?> active <?php endif; ?>">
                    ...
                    <li class="nav-item">
                        <a href="<?php echo e(route('package-category.index'). '?language=' . $lang_code); ?>"
                           class="nav-link <?php if(request()->path() == 'admin/package-category'): ?> active <?php endif; ?>">

                            <i class="nav-icon  fab fa-sith"></i>
                            <p>
                                <?php echo e(__('Packages Categories')); ?>
    ...
    <!-- /.sidebar -->
</aside><?php /**PATH /home/customer/www/new.vadecom.net/public_html/core/resources/views/admin/partials/side-navbar.blade.php ENDPATH**/ ?>