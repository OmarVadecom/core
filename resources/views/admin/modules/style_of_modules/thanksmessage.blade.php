    ...
    <div class="tab-content" id="nav-tabContent">
      ...
      <div class="col-md-12 tab-pane fade show active" id="nav-en-thanks" role="tabpanel" aria-labelledby="nav-en-thanks-tab" >
          <div class="form-group my-3">
            ...
            <textarea type="text" name="mod[{{ $randNumModule }}][Thanksmessage][content]" class="form-control">{{  isset($moduleAttributes['content']) ? $moduleAttributes['content'] : '' }}</textarea>
          </div>
      </div>
      ...
      <div class="col-md-12 tab-pane fade" id="nav-ar-thanks" role="tabpanel" aria-labelledby="nav-ar-thanks-tab">
        <div class="form-group my-3">
          ...
          <textarea type="text" name="mod[{{ $randNumModule }}][Thanksmessage][ar_content]" class="form-control">{{  isset($moduleAttributes['ar_content']) ? $moduleAttributes['ar_content'] : ''}}</textarea>
        </div>
      </div>
