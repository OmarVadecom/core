                                ...
                                <div class="col-12">
                                    <div class="row">
                                        <div class="col-12">
                                            ...
                                            <form action="{{ route('admin.language-manage') }}" method="get">
                                                <div class="row">
                                                    <div class="col-3">
                                                        <label
    ...
    <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                ...
                <form
                    action="{{ route('admin.language-manage-store')}}"
                ...
                >
                    ...
                    <div class="modal-body">
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input
                                    placeholder="@lang('e.g. Japaneese, Portuguese')"
