            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="card card-primary card-outline">
                        ...
                        <div class="card-body">
                            <form
                                action="<?php echo e(route('admin.why_chooseus_update', $static->language_id)); ?>"
                            ...
                            >
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <img
                                            src="<?php echo e(asset('assets/front/img/'.$static->w_c_us_image1)); ?>"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <img
                                            src="<?php echo e(asset('assets/front/img/'.$static->w_c_us_image2)); ?>"
                                            class="mw-400 mb-3 img-demo show-img"
                                            alt=""
                                        />
                                        <div class="custom-file">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input
                                            value="<?php echo e($static->w_c_us_title); ?>"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input
                                            value="<?php echo e($static->w_c_us_sub_title); ?>"
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/new.vadecom.net/public_html/core/resources/views/admin/home/why-choose-us/index.blade.php ENDPATH**/ ?>