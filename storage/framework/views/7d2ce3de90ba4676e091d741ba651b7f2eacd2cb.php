                ...
                <div class="col-lg-12">
                    <div class="card card-primary card-outline">
                        ...
                        <div class="card-body">
                            ...
                            <form
                                action="<?php echo e(route('admin.testimonialcontent.update',  $english_saectiontitle->language_id)); ?>" enctype="multipart/form-data" class="form-horizontal" method="POST">
                                <?php echo csrf_field(); ?>
                                ...
                                <div class="tab-content" id="nav-tabContent">
                                    <div class="col-md-12 tab-pane fade show active" id="nav-en-testimonial" role="tabpanel" aria-labelledby="nav-en-testimonial-tab" >
                                        <div class="form-group row my-3">
                                            ...
                                            <div class="col-sm-10">
                                                <input
                                                    value="<?php echo e($english_saectiontitle->testimonial_title); ?>"
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input
                                                    value="<?php echo e($english_saectiontitle->testimonial_subtitle); ?>"
                                    ...
                                    <div class="col-md-12 tab-pane fade" id="nav-ar-testimonial" role="tabpanel" aria-labelledby="nav-ar-testimonial-tab">
                                        <div class="form-group row my-3">
                                            <label class="col-sm-2 control-label">
                                                <?php echo e(__('عنوان الشهادة')); ?>

                                                <span class="text-danger">*</span>
                                            </label>
                                            <div class="col-sm-10">
                                                <input
                                                    value="<?php echo e($arabic_saectiontitle->testimonial_title); ?>"
                                                    placeholder="<?php echo e(__('Testimonial Title')); ?>"
                                                    name="ar_testimonial_title"
                                                    class="form-control"
                                                    type="text"
                                                >
                                                <?php if($errors->has('ar_testimonial_title')): ?>
                                                    <p class="text-danger"> <?php echo e($errors->first('ar_testimonial_title')); ?> </p>
                                                <?php endif; ?>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-sm-2 control-label">
                                                <?php echo e(__('عنوان الشهادة الفرعي')); ?>

                                                <span class="text-danger">*</span>
                                            </label>
                                            <div class="col-sm-10">
                                                <input
                                                    value="<?php echo e($arabic_saectiontitle->testimonial_subtitle); ?>"
                                                    placeholder="<?php echo e(__('Testimonial Sub-Title')); ?>"
                                                    name="ar_testimonial_subtitle"
                                                    class="form-control"
                                                    type="text"
                                                >
                                                <?php if($errors->has('ar_testimonial_subtitle')): ?>
                                                    <p class="text-danger"> <?php echo e($errors->first('ar_testimonial_subtitle')); ?> </p>
                                                <?php endif; ?>
                                            </div>
                                        </div>
                                    </div>
