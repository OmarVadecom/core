                    ...
                    <div class="name">
                        ...
                        <div class="thum" ng-click="toggleCheck(photo.id)">
                            <img ng-if="photo.ext=='png' ||
                                    ...
                                    photo.ext=='jpeg' ||
                                    photo.ext=='webp' ||
                                    photo.ext=='gif'" ng-src="<?php echo e($thumbUrl); ?>/{{ photo.name }}" alt="{{ photo.name }}">
    ...
    filemanager.controller('FilemanagerCtrl', function ($scope, $http, $q, $window, $timeout) {
        ...
        $scope.bulkDelete = function () {
            ...
            if (confirm("This action will delete " + $scope.checkedIds.length + " number of files. Are you sure?")) {
                ...
                $scope.checkedIds.forEach(function (id) {
                    var promise = $http.post('<?php echo e(route('filemanager.base_route')); ?>?action=delete', {'id': id});
        ...
        $scope.deletePhoto = function (photo, index) {
            ...
            if (confirm("Are you sure?")) {
                photo.deleting = true
                $http.post('<?php echo e(route('filemanager.base_route')); ?>?action=delete', {'id': photo.id})
                    .success(function (data) {
                        console.log(data)
...
</html><?php /**PATH C:\laragon\www\core\vendor\haruncpi\laravel-simple-filemanager\src/views/index.blade.php ENDPATH**/ ?>