                            ...
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="row">
                                        <div class="col-12">
                                            <h4> Filter Data </h4>
                                            <form action="<?php echo e(route('admin.gcategory')); ?>" method="get">
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $gcategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $gcategory): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr id="gcategory-bulk-delete">
                                            <td>
                                                <input type="checkbox" class="bulk-item" value="<?php echo e($gcategory->id); ?> " />
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <a
                                                    href="<?php echo e(route('admin.gcategory.edit', $gcategory->id)); ?>"
                                                ...
                                                <form
                                                    action="<?php echo e(route('admin.gcategory.delete', $gcategory->id )); ?>"
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/new.vadecom.net/public_html/core/resources/views/admin/gallery/gallery-category/index.blade.php ENDPATH**/ ?>