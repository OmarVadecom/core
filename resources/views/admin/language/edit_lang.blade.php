                        ...
                        <div class="card-body">
                            <table class="table table-bordered table-striped data_table" id="myTable">
                                ...
                                <tr>
                                    ...
                                    <th scope="col" style="width: 10% !important;">@lang('Action')</th>
                                </tr>
                                </thead>
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td data-label="@lang('Action')">
                                            <a href="javascript:void(0)"
                                               ...
                                               data-key="{{$k}}"
                                               data-value="{{$lang}}"
                                               class="editModal icon-btn ml-1 btn btn-primary  btn-sm w-100 mb-1"
                                               >
                                            ...
                                            <a href="javascript:void(0)"
                                               ...
                                               class="icon-btn btn--danger ml-1 deleteKey btn btn-danger btn-sm  w-100"
                                               >
