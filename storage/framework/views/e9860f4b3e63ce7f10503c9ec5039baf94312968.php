            ...
            <div class="tab-content" id="nav-tabContent">
                <div class="tab-pane fade show active" id="nav-en-text-left-img"  role="tabpanel" aria-labelledby="nav-en-text-left-img-tab">
                    ...
                    <div class="form-group row my-3">
                        <label class="col-sm-2 control-label"><?php echo e(__('Image')); ?></label>
                        <div class="col-sm-10">
                                <input type="text" class="form-control" name="images[<?php echo e($randNumModule); ?>][text_with_left_image][imageFile]" id="image">
...
<div class="clearfix"></div><?php /**PATH C:\PHP\htdocs\new_vadecom\core\resources\views/admin/modules/style_of_modules/text_with_left_image.blade.php ENDPATH**/ ?>