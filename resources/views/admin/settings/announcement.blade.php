            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-primary card-outline">
                        ...
                        <div class="card-body">
                            <form
                                action="{{ route('admin.update_announcement', $st->language_id ) }}" method="POST"
                                enctype="multipart/form-data"
                                class="form-horizontal"
                            >
                                @csrf
                                <div class="form-group row">
                                    <label class="col-sm-3 control-label">{{ __('Announcement Popup') }}
                                        <span class="text-danger">*</span>
                                    </label>
                                    <div class="col-sm-9">
                                        <input
                                            {{ $commonsetting->is_announcement == '1' ? 'checked' : '' }} data-size="large"
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-3 control-label">{{ __('Announcement Image') }}
                                        <span class="text-danger">*</span>
                                    </label>
                                    <div class="col-sm-9">
                                        <img
                                        ...
                                        <p class="help-block text-info">
                                            {{ __('Upload 960X519 (Pixel) Size image for best quality. Only jpg, jpeg, png image is allowed.') }}
                                        </p>
