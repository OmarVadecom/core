...
class ProductController extends Controller
{
    ...
    public function products(Request $request){
        ...
        $data['products'] = Product::where('language_id', $lang)
                            ->when($request['price'], function ($q) use ($request) {
                                return $q->where('current_price', 'LIKE', '%' . $request['price'] . '%');
        ...
        $data['productCategories'] = ProductCategory::where('language_id',$lang)->orderBy('id', 'DESC')->get();
