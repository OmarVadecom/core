                                ...
                                <form class="form-horizontal" action="<?php echo e(route('admin.feature.store')); ?>" method="POST">
                                    ...
                                    <div class="tab-content" id="nav-tabContent">
                                        ...
                                        <div class="col-md-12 tab-pane fade" id="nav-ar-feature" role="tabpanel" aria-labelledby="nav-ar-feature-tab">
                                            ...
                                            <div class="form-group row">
                                                <label  class="col-sm-2 control-label"><?php echo e(__('النص')); ?><span class="text-danger">*</span></label>
                
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control" name="ar_text" placeholder="<?php echo e(__('Text')); ?>" value="<?php echo e(old('ar_text')); ?>">
