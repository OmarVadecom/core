...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/front/') }}/css/new.css?v={{ time() }}">
    <link rel="stylesheet" href="{{ asset('assets/front/') }}/css/dynamic-css.css?v={{ time() }}">
    ...
    <!-- RTL css -->
    <link rel="stylesheet" href="{{ asset('/') }}assets/front/css/rtl.css?v=4">
    @endif
...
<body
    class=" @if($commonsetting->theme_version == 'theme7' || $commonsetting->theme_version == 'theme8' ) gradint_body @endif">
    ...
    <!--====== Main js ======-->
    <script src="{{ asset('assets/front/') }}/js/main.js?v=2"></script>
