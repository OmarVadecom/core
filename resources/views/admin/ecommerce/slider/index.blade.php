                                ...
                                <div class="col-12">
                                    <div class="row">
                                        <div class="col-12">
                                            ...
                                            <form action="{{ route('admin.ecommerce.slider') }}" method="get">
                                ...
                                <tbody>
                                    @foreach ($sliders as $id => $slider)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('admin.ecommerce.sliderEdit', $slider->id) }}" class="btn btn-info btn-sm">
                                                    <i class="fas fa-pencil-alt"></i>{{ __('Edit') }}
                                                </a>
                                                <form
                                                    action="{{ route('admin.ecommerce.sliderDelete', $slider->id ) }}"
