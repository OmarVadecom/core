...
<head>
    ...
    <title>
        ...
        <?php else: ?>
        <?php echo e($setting->website_title); ?>
    ...
    <link
        href="https://fonts.googleapis.com/css2?family=Cairo:wght@200;300;400&family=Tajawal:wght@200;300;400&display=swap"
        rel="stylesheet">
    ...
    <link rel="stylesheet" href="<?php echo e(asset('assets/front/')); ?>/css/new.css?v=<?php echo e(time()); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('assets/front/')); ?>/css/dynamic-css.css?v=<?php echo e(time()); ?>">
    ...
    <!-- RTL css -->
    <link rel="stylesheet" href="<?php echo e(asset('/')); ?>assets/front/css/rtl.css?v=4">
    <?php endif; ?>
...
<body
    class=" <?php if($commonsetting->theme_version == 'theme7' || $commonsetting->theme_version == 'theme8' ): ?> gradint_body <?php endif; ?>">

    <?php if($visibility->is_preloader): ?>
    <!--====== PRELOADER PART START ======-->
    <div id="preloader" style="background-color: <?php echo e($commonsetting->preloader_bg_color); ?>">
        <div class="image">
            <img src="<?php echo e(asset('assets/front/img/'. $commonsetting->preloader_icon )); ?>" alt="not found">
        </div>
    </div>
    <!--====== PRELOADER PART START ======-->
    <?php endif; ?>
    ...
    <!--====== Main js ======-->
    <script src="<?php echo e(asset('assets/front/')); ?>/js/main.js?v=2"></script>
    ...
    <script>
           $(document).ready(function () {
                $('.btn-footer').click(function(){
                    var id=$(this).attr('id');
                    $('.'+id).slideToggle().siblings().slideDown();
...
</html><?php /**PATH C:\PHP\htdocs\new_vadecom\core\resources\views/front/layout.blade.php ENDPATH**/ ?>