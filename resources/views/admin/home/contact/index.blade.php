                            ...
                            <div class="card-body">
                                <form class="form-horizontal" action="{{ route('admin.contact_section_update', $static->language_id) }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <img class="mw-400 mb-3 img-demo show-img" src="{{ asset('assets/front/img/'.$static->contact_form_image) }}" alt="" width="150px" height="150px">
                                            <div class="custom-file">
                                                <label class="custom-file-label" for="contact_form_image">{{ __('Choose New Image') }}</label>
                                                <input type="file" class="custom-file-input up-img" name="contact_form_image" id="contact_form_image" width="150px" height="150px">
                                            </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <img class="mw-400 mb-3 img-demo show-img" src="{{ asset('assets/front/img/'.$static->contact_section_bg_image) }}" alt="" width="150px" height="150px">
                                            <div class="custom-file">
