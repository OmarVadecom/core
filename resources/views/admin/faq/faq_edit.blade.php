                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="tab-content" id="nav-tabContent" >
                                        <div class=" col-sm-10 tab-pane fade show active " id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                                            ...
                                            <input type="text" class="form-control" name="question_en" placeholder="{{ __('question') }}" value="{{$faq->question_en}}">
                                            ...
                                            <textarea id="editor1" class="form-control" name="answer_en">{{$faq->answer_en}} </textarea>
                                        ...
                                        <div class="col-sm-10 tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-home-tab">
                                            ...
                                            <input type="text" class="form-control" name="question_ar" placeholder="{{ __('السؤال') }}" value="{{$faq->question_ar}}">
                                            ...
                                            <textarea id="editor2" class="form-control" name="answer_ar">{{$faq->answer_ar}} </textarea>
