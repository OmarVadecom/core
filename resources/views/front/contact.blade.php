...
@if(isset($socials) && Auth::guard('admin')->check())  
                <div  style="position:fixed;top:0px;height: 25px;z-index:5555555; width:100%; border-bottom-left-radius: 10px; background-color:#cce5ff; border-bottom-right-radius: 10px;">
                    <a  target="_blank" style="text-decoration: underline; text-align: center; margin: auto; display: block; color: #ffffff; font-weight: 700; font-size: 14px;" href="{{route('admin.contact_section')}}"><i class="far fa-edit"></i> Edit this Page</a>
                </div>
    @endif
