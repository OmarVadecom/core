                ...
                <div class="card card-primary card-outline">
                    ...
                    <div class="card-body">
                        <form class="form-horizontal" action="<?php echo e(route('admin.dynamic_page.update',  $dynamicpage->id)); ?>" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <div class="tab-content" id="nav-tabContent" >
                                        <div class=" col-sm-10 tab-pane fade show active " id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                                            ...
                                            <input type="text" class="form-control titleinp" name="en_title" data-slug="1"  placeholder="<?php echo e(__('Title')); ?>" value="<?php echo e($dynamicpage_en->title); ?>" required>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-4">
                                    <select class="form-control lang" name="slug_with_category">
                                        <option value="1" <?php echo e($dynamicpage_en->slug_with_category == 1 ? 'selected' : ''); ?>> Yes </option>
                                        <option value="0" <?php echo e($dynamicpage_en->slug_with_category == 0 ? 'selected' : ''); ?>> No </option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                <label for="value" class="col-sm-2 control-label"><?php echo e(__('Order')); ?></label>
                            ...
                            <div class="form-group row">
                                <label for="status" class="col-sm-2 control-label"><?php echo e(__('Status')); ?></label>
                            ...
                            <div class="form-group row">
                                <label class="col-sm-2 control-label"><?php echo e(__('Modules')); ?></label>
                                <div class="col-sm-10">
