                ...
                <div class="col-lg-12">
                    <div class="card card-primary card-outline">
                        <div class="card-header">
                            <h3 class="card-title mt-1">{{ __('Add Faq Category') }}</h3>
                            <div class="card-tools">
                                <a href="{{ route('faq-category.index')}}" class="btn btn-primary btn-sm">
                        ...
                        <div class="card-body">
                            <form class="form-horizontal" action="{{ route('faq-category.store') }}" method="POST">
                                @csrf
                                <div class="form-group row">
                                    ...
                                    <div class="tab-content" id="nav-tabContent" >
                                        <div class=" col-sm-10 tab-pane fade show active " id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                                            ...
                                            <input type="text" class="form-control" name="name_en" placeholder="{{ __('Name') }}" value="{{ old('name') }}" required>
                                        ...
                                        <div class="col-sm-10 tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-home-tab">
                                            ...
                                            <input type="text" class="form-control" name="name_ar" placeholder="{{ __('الاسم') }}" value="{{ old('الاسم') }}" required>
