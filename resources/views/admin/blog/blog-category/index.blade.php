                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="card-tools d-flex justify-content-end">
                                        ...
                                        <a
                                                href="{{ route('admin.bcategory.add'). '?language=' . $currentLang->code }}"
                                ...
                                <tbody>
                                    @foreach ($bcategories as $id => $bcategory)
                                        <tr id="bcategory-bulk-delete">
                                            <td>
                                                <input type="checkbox" class="bulk-item" value="{{ $bcategory->id}}" />
                                            </td>
                                            <td>
                                                {{ $bcategory->name }}
                                            </td>
                                            ...
                                            <td>
                                                <a href="{{ route('admin.bcategory.edit', $bcategory->id) }}" class="btn btn-info btn-sm">
                                                    <i class="fas fa-pencil-alt"></i>
                                                    {{ __('Edit') }}
                                                </a>
                                                <form
                                                    action="{{ route('admin.bcategory.delete', $bcategory->id ) }}"
